...
namespace LoadLink.LoadMatching.Persistence.Test
{
    public class EquipmentPostingRepositoryIntegratedWithCachingTest
    {
        ...
        public EquipmentPostingRepositoryIntegratedWithCachingTest(IRedisCacheClient redisCacheClient, IServiceProvider serviceProvider, ILeadCaching leadCaching, IMapper mapper, IConnectionFactory connectionFactory)
        {
        ...
        public async Task RepositoryBulkInsertTest()
        {
            ...
            var repository = new EquipmentPostingRepository(_connectionFactory, _mapper);

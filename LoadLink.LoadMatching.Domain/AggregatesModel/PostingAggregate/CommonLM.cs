...
namespace LoadLink.LoadMatching.Domain.AggregatesModel.PostingAggregate
{
    ...
    public static class CommonLM
    {
        ...
        public static string PostingAttributeNumToString(int postAttrib)
        {
            //-----------------------------------------------------------------------------------
            //Purpose    This function will return a numeric representation of the
            //           Posting Attribute string
            ...
            //  N   -   Inbound
            //
            //Returns    Posting Attribute string
            //Effects    None
            //-----------------------------------------------------------------------------------
            // Change Log
            // Date       Developer    Description
            // -------    -----------  --------------------------------------------------------------
            // 2021.09.09 Saffi         Initial Release
            //-----------------------------------------------------------------------------------
            var allAttrib = "ABWCZITVXMGFHEN";

            var result = "";

            for (int i = 0; i <= ((allAttrib.Length) - 1); i++)
            {
                if (((int)(Math.Pow(2, i)) & postAttrib) > 0)
                    result = result + allAttrib.Substring(i + 1, 1);
            }

...
namespace LoadLink.LoadMatching.Api.Controllers
{
    ...
    public class EquipmentLiveLeadController : ControllerBase
    {
        ...
        public EquipmentLiveLeadController(IEquipmentLiveLeadService datEquipmentLiveLeadService, IUserHelperService userHelperService, IOptions<AppSettings> appSettings)
        {

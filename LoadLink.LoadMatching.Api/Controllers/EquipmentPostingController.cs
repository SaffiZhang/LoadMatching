...
namespace LoadLink.LoadMatching.Api.Controllers
{
    ...
    public class EquipmentPostingController : ControllerBase
    {
        ...
        public EquipmentPostingController(IEquipmentPostingService equipmentPostingService, IUserHelperService userHelperService, IOptions<AppSettings> appSettings )
        {

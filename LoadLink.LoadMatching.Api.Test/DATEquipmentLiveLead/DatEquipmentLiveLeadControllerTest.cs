using AutoMapper;
using EquipmentLink.EquipmentMatchings.Application.DATEquipmentLiveLead.Profiles;
...
namespace EquipmentLink.EquipmentMatchings.Api.Test.DATEquipmentLiveLead
{
